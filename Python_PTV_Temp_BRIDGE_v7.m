...
flag.plot_profile_lines = 1;   % Toggle vertical profile line plots for a specific time/date5
...
% points below a specified altitude.
    ...
    low_range_indices = find(alt_vector <= max_alt_km * 1000); % Convert km to m
