function[] = DIAL_Analysis_function_NetCDF_v4(folder_in, date_in, MCS, write_data_folder, flag, node, wavemeter_offset,...
...
if flag.near == 1
  [dummy,dummy,near_on, near_off, folder_in] = File_Retrieval_NetCDF_v4(flag, MCS.bins, folder_in); %use to read binary data (bin number passed in) 
