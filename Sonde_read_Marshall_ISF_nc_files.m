function[sonde_AH_grid, MPD_AH_grid, range_grid] = Sonde_read_Marshall_ISF_nc_files(jj, elevation, sondedir, sondefilename, N_avg_comb, duration, range_grid_size, range_grid_in,  comb_AH_var,  sonde_end_int,  plot_path, flag) 
...
sonde_date = sondefilename{jj}(12:19);
sonde_time = sondefilename{jj}(21:26);
