function[sonde_T_grid, MPD_T_grid, range_grid] = Sonde_read_M2HATS_temp_files(jj, elevation, sondedir, sondefilename, Temp_comb_avg, Temp_comb_var, T_lapse, duration, range_grid_size, range_grid_in, sonde_end_int, plot_path, flag) 
