...
Norm_Tenti = sptsig6./trapz(sptsig6);
% Norm_Tenti = sptsig6./max(sptsig6);
plot(GHz, Norm_Tenti, 'r')
...
name=strcat('Owen_2_Nov_comparison_T287_P082');
% name=strcat('Abari_ILRC27');
